...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-6">
            ...
            <button data-target="#importUsers" data-toggle="modal" class="btn btn-outline-secondary float-right mr-2"><i class="fas fa-upload mr-2"></i> Import Students</button>
        </div>
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn btn-toolbar justify-content-center">
                                    <a href="{{ route('student.edit', 1) }}" class="btn btn-sm btn-primary mr-2"><i class="fa fa-pen"></i></a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fas fa-upload mr-2"></i> Import Students</h5>
