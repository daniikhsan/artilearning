    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('course-setting.store') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select class=" @error('user_id') is-invalid @enderror select2" id="user_id" name="user_id" style="width: 100%;">
                                ...
                                @foreach($lecturers as $lecturer)
                                    <option value="{{ $lecturer->id }}" {{ old('lecturer') == $lecturer->id ? 'selected' : '' }}>{{ Str::title($lecturer->name) }}</option>
                                @endforeach
                            </select>
                            @error('user_id')
                                <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    <input type="number" name="start_hour" class="form-control rounded-0 @error('start_hour') is-invalid @enderror" id="start_hour" placeholder="Hour..." value="{{ old('start_hour') }}" min="0" max="23">
                                                    @error('start_hour')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    <input type="number" name="start_minute" class="form-control rounded-0 @error('start_minute') is-invalid @enderror" id="start_minute" placeholder="Minute..." value="{{ old('start_minute') }}" min="0" max="59">
                                                    @error('start_minute')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    <input type="number" name="end_hour" class="form-control rounded-0 @error('end_hour') is-invalid @enderror" id="end_hour" placeholder="Hour..." value="{{ old('end_hour') }}" min="0" max="23">
                                                    @error('end_hour')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    <input type="number" name="end_minute" class="form-control rounded-0 @error('end_minute') is-invalid @enderror" id="end_minute" placeholder="Minute..." value="{{ old('end_minute') }}" min="0" max="59">
                                                    @error('end_minute')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
