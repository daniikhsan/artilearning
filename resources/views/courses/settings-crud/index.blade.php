...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-md-6">
                <a href="{{ route('course-setting.create') }}" class="btn btn-outline-primary float-right"><i class="fas fa-plus mr-2"></i> Add Course</a>
            </div>
        </div><!-- /.row -->
                                ...
                                <td class="text-center">
                                    <div class="btn btn-toolbar justify-content-center">
                                        ...
                                        <form action="{{ route('course-setting.destroy', $course->id) }}" method="post" onsubmit=" return confirm('Are you sure want to delete this item?')">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-sm btn-danger {{ $course->role == 'admin' ? 'disabled' : '' }}"><i class="fa fa-trash"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
